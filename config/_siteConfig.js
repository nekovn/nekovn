...
export default {
  ...
  about:'当サイト（http://nekovn.jp）は、株式会社NekoVn が管理し、情報を提供しているウェブサイトです。当サイトを利用される前に以下の注意点をお読みいただき、ご了解いただいた上でご利用ください。利用者は、自らの判断と責任において、広告等を契機とした広告主などの第三者と連絡、交渉ないし取引その他の接触（以下「接触等」といいます。）をすることができます。当社は、利用者と第三者との間における接触等について、一切の関与をせず、かつ、責任を負いません。',
