...
export default {
  ...
  url:'http://learning-nuxtjs.xyz',
  email:'sukivietnam19092811@gmail.com',
  address:'東京都豊島区西池袋5-19-20',
  tell:'090 2259 2811',
  pageType:'website',
  image:'https://picsum.photos/1800/1803',
  about:'当サイト（http://suki-vietnam.com/）は、株式会社suki-vietnam が管理し、情報を提供しているウェブサイトです。当サイトを利用される前に以下の注意点をお読みいただき、ご了解いただいた上でご利用ください。利用者は、自らの判断と責任において、広告等を契機とした広告主などの第三者と連絡、交渉ないし取引その他の接触（以下「接触等」といいます。）をすることができます。当社は、利用者と第三者との間における接触等について、一切の関与をせず、かつ、責任を負いません。',
